...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface paintingSunlight = Typeface.createFromAsset(getAssets(), "fonts/PaintingintheSunlight.ttf");
        mTitleTextView.setTypeface(paintingSunlight);
        mEnterButton.setTypeface(paintingSunlight);
